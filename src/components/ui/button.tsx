  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-primary text-primary-foreground font-semibold neon-glow hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)] transition-shadow duration-300",
        "neon-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary/10 neon-glow font-semibold",
        "neon-cyan": "bg-accent text-accent-foreground font-semibold neon-glow-cyan hover:shadow-[0_0_30px_hsl(var(--accent)/0.6)] transition-shadow duration-300",
        glass: "glass text-foreground hover:bg-muted/50 font-medium",
      },
      size: {
